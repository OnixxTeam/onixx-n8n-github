...
# #
# #   command="/Users/stellar-builder/bin/host-build-dispatch",restrict ssh-ed25519 AAAA... <employee-login>-agent
# # (one line per employee container that needs Mac-host build delegation)

#--- 12. Operator admin key for shell access -----------------------------
# Also add your personal admin key WITHOUT the command= restriction —
# this is for you to ProxyJump through stellar-builder into the
# containers (same key you put in ADMIN_SSH_PUBKEY in manager.env and
# each employees/<login>.env):
#
#   ssh-ed25519 AAAA... operator-admin
#
