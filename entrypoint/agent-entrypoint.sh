...
sudo -u agent \
    --preserve-env=ROLE,EMPLOYEE_LOGIN,EMPLOYEE_GITHUB_LOGIN,GITHUB_TOKEN,GITHUB_REPO,ANTHROPIC_API_KEY,ADMIN_SSH_PUBKEY,N8N_SSH_PUBKEY,MANAGER_SSH_PUBKEY,GIT_COMMITTER_NAME,GIT_COMMITTER_EMAIL,MAC_HOST,MAC_HOST_USER,MAC_HOST_PORT \
